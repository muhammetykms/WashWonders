//
//  InstitutionalLoginViewController.swift
//  CarWashing
//
...
import UIKit
import FirebaseAuth
class InstitutionalLoginViewController: UIViewController, UITextFieldDelegate {
        ...
        if emailTextField.text! != "" && passwordTextField.text! != ""{
            Auth.auth().signIn(withEmail: emailTextField.text!, password: passwordTextField.text!) { (authdata, error) in
                if error != nil {
                    ...
                    self.performSegue(withIdentifier: "toLoginTabBarSegue", sender: nil)
    ...
    @objc func forgotPasswordButtonClicked() {
        performSegue(withIdentifier: "toForgotPassSegue", sender: nil)
    }
